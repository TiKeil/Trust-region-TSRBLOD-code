...
#SBATCH --nodes=50                  # the number of nodes you want to reserve
...
#SBATCH --job-name=test_exp_2       # the name of your job
#SBATCH --mail-type=ALL             # receive an email when your job starts, finishes normally or is aborted
#SBATCH --mail-user=t_keil02@uni-muenster.de # your mail address


# set an output file
#SBATCH --output /scratch/tmp/t_keil02/tr_tsrblod/final/exp2.dat
